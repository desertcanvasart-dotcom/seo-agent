      ...
      {sites.length === 0 ? (
        <div className="card">
          <div className="card-body text-center py-16">
            ...
            <h2 className="text-lg font-semibold mb-2">Welcome to SEO Agent</h2>
            <p className="text-sm text-[var(--text-secondary)] mb-6 max-w-md mx-auto">
              Add a website and we&apos;ll automatically crawl it, audit every page for SEO &amp; AI readiness, find internal linking opportunities, and generate content briefs.
            </p>
            <Link href="/new" className="btn btn-primary">Add Your First Website</Link>

            <div className="grid grid-cols-4 gap-4 mt-10 text-left max-w-2xl mx-auto">
              {[
                { title: "Crawl", desc: "Discover every page with a real browser", color: "var(--accent)" },
                { title: "Audit", desc: "SEO & GEO scores with fix priorities", color: "var(--green)" },
                { title: "Link", desc: "AI-powered internal link suggestions", color: "var(--yellow)" },
                { title: "Brief", desc: "Content recipes from competitor research", color: "var(--purple)" },
              ].map((s) => (
                <div key={s.title} className="text-center">
                  <div className="w-10 h-10 rounded-lg mx-auto mb-2 flex items-center justify-center" style={{ background: s.color + "20" }}>
